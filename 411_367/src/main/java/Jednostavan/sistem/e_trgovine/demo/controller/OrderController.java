...
public class OrderController {
    ...
    public String deleteOrder(@PathVariable Long id,
        ...
        Order order = orderService.getOrderById(id);
        if (order == null) {
            redirectAttributes.addFlashAttribute("error", "Narudžba nije pronađena");
            return "redirect:/orders";
        }

        // Provjeri da li je korisnik vlasnik narudžbe ili admin
        if (user.getRole().equals("ADMIN") || order.getUser().getId().equals(user.getId())) {
            ...
            redirectAttributes.addFlashAttribute("error", "Nemate dozvolu za brisanje ove narudžbe");
        }
